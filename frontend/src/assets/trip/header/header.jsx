...
import { MenuModal } from '../../website/menuBox'
...
export function Header(props) {
    const { trip_name, firstName, setLoggedIn, loggedIn, currentTripId } = useTripInfo();
                ...
                <header className={styles.LinksHeader}>
                    <div className={styles.links}>
                        ...
                        <button className={styles.menu} onClick={() => setMenuOpen((prev) => !prev)}>
                            {menuOpen ?
                                <svg xmlns="http://www.w3.org/2000/svg" height="38px" viewBox="0 -960 960 960" width="38px" fill="#000000"><path d="m476-420 84-84 84 84 56-56-84-84 84-84-56-56-84 84-84-84-56 56 84 84-84 84 56 56ZM320-240q-33 0-56.5-23.5T240-320v-480q0-33 23.5-56.5T320-880h480q33 0 56.5 23.5T880-800v480q0 33-23.5 56.5T800-240H320Zm0-80h480v-480H320v480ZM160-80q-33 0-56.5-23.5T80-160v-560h80v560h560v80H160Zm160-720v480-480Z" /></svg>
                                :
                                <svg xmlns="http://www.w3.org/2000/svg" height="38px" viewBox="0 -960 960 960" width="38px" fill="#000000"><path d="M120-240v-80h720v80H120Zm0-200v-80h720v80H120Zm0-200v-80h720v80H120Z" /></svg>
                            }
                        </button>
                        {menuOpen && <MenuModal />}
                        ...
                        <HashLink className={styles.eachLink} smooth to="/#top">Welcome</HashLink>


                        <HashLink className={styles.eachLink} smooth to="/#features">Features</HashLink>

                        <img src="/preview.png" alt="logo" />


                        {/* <Link>Contact</Link> */}
                        <Link className={styles.eachLink} to={'/about'}>About us</Link>
                        <Link className={styles.eachLink} to={'/login'}>Login/Signup</Link>

...
export function MainPage() {
    ...
    useEffect(() => {
        const getDataOnPageLoad = async () => {
            setLoading(true);
            const data = await fetchAndRenderAllData(() => navigate('/login'));
        ...
        <div className='headers-and-content'>
            ...
            {!loading && <div className='content'>
                ...
                <nav className="flex justify-center space-x-4 mb-8 text-lg font-medium">
                     <Link to="/Suggestions" className="flex-1 bg-gray-50 p-6 rounded-xl shadow-md">
  ...
  <span className="text-2xl font-bold">Suggested Activities</span>
                             ...
                             <Link to="/my_expenses" className="flex-1 bg-gray-50 p-6 rounded-xl shadow-md">

                        <h2 className="text-2xl font-bold text-gray-800 mb-4 flex items-center">
  
  <svg className="mr-2" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#75FB4C"><path d="M240-80q-50 0-85-35t-35-85v-120h120v-560l60 60 60-60 60 60 60-60 60 60 60-60 60 60 60-60 60 60 60-60v680q0 50-35 85t-85 35H240Zm480-80q17 0 28.5-11.5T760-200v-560H320v440h360v120q0 17 11.5 28.5T720-160ZM360-600v-80h240v80H360Zm0 120v-80h240v80H360Zm320-120q-17 0-28.5-11.5T640-640q0-17 11.5-28.5T680-680q17 0 28.5 11.5T720-640q0 17-11.5 28.5T680-600Zm0 120q-17 0-28.5-11.5T640-520q0-17 11.5-28.5T680-560q17 0 28.5 11.5T720-520q0 17-11.5 28.5T680-480Z"/></svg>
